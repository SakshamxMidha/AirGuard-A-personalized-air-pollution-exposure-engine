...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Live-Deployed-success?style=flat-square&logo=render"/>
</p>

<p align="center">
  <a href="https://airguard-a-personalized-air-pollution.onrender.com" target="_blank">
    <img src="https://img.shields.io/badge/🌐 Live Demo-Visit App-00e5c3?style=for-the-badge"/>
  </a>
  <a href="https://airguard-backend-g909.onrender.com/api/aqi/public/current?latitude=18.52&longitude=73.85" target="_blank">
    <img src="https://img.shields.io/badge/⚙️ API-Live Backend-0062ff?style=for-the-badge"/>
  </a>
</p>
...
| | URL |
|-|-|
| 🌐 **Frontend (App)** | https://airguard-a-personalized-air-pollution.onrender.com |
| ⚙️ **Backend API** | https://airguard-backend-g909.onrender.com/api |
| 🧪 **Public AQI Test** | https://airguard-backend-g909.onrender.com/api/aqi/public/current?latitude=18.52&longitude=73.85 |
...
| **Deployment** | Docker, Render.com (backend + DB), Render Static Site (frontend) |
...
> **Base URL (Production):** `https://airguard-backend-g909.onrender.com/api`
...
For production, set environment variables (Docker or Render dashboard):

```bash
JWT_SECRET=your-random-256bit-secret
DATABASE_URL=jdbc:postgresql://host/airguard_db
DB_USER=airguard_db_user
DB_PASSWORD=secure-password
ALLOWED_ORIGINS=https://airguard-a-personalized-air-pollution.onrender.com
...
This app is deployed on [Render.com](https://render.com) using the free tier.

| Service | Type | URL |
|-|-|-|
| Frontend | Static Site | https://airguard-a-personalized-air-pollution.onrender.com |
| Backend | Web Service (Docker) | https://airguard-backend-g909.onrender.com/api |
| Database | PostgreSQL | Render managed (internal) |
...
| `DATABASE_URL` | `jdbc:postgresql://...` (from Render PostgreSQL internal URL) |
